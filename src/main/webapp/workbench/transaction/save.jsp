	...
	<script type="text/javascript">
		...
		/*
			...
			关于阶段和可能性
				...
				stag2Possibility.properties 这个文件表示的是阶段和键值对之间的对应的关系
				将来，我们通过stage，以及对应关系的文件来取得可能性这个值
				这种需求在交易模块中，需要大量的使用到
		...
		$(document).ready(function(){
			...
			$("#create-stage").change(function(){
				...
				/*
					...
					因为今天的stage是一个可变的变量（动态数据）
					如果是这样的key，那么我们就不能以传统的json.key的形式取值
					我们要使用的取值方式为
					json[key]
...
<body>
	...
	<form class="form-horizontal" action="workbench/transaction/save.do" role="form" id="tranForm" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control time1" name="expected_date" id="create-expectedClosingDate" readonly />
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" name="source" id="create-activitySrc" value="发传单1">
				<input type="hidden" name="activityId" value="0727ad21ef04450fbdf027d4b29e5841" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="contactsId" value="574d1891498f42bc8a37d8a0fd24400b" />
			</div>
		</div>
