...
<%@ page import="com.laodeng.crm.settings.domain.DicValue"%>
<%@ page import="java.util.List" %>
<%@ page import="java.util.Map"%>
<%@ page import="java.util.Set" %>
<%@ page import="com.laodeng.crm.workbench.domain.Tran" %>
<%
...
<script type="text/javascript">
		...
		$.ajax({
			...
			success : function(data){
				...
				$.each(data, function(i, n){
					...
					html += '<td>'+ n.expected_date +'</td>';
					html += '<td>'+ n.create_time +'</td>';
					html += '<td>'+ n.create_by +'</td>';
					html += '</tr>';
	...
	function changeStage(stage, i){
		...
		$.ajax({
			...
			data : {
				...
				"expectedDate" : "${t.expected_date}" // 生成交易历史使用
			...
			success : function(data){
				...
				if(data.success){
					...
					// 改变阶段成功后
					// (1) 需要在详细信息页上局部刷新 刷新阶段、可能性、修改人、修改事件
					$("#stage").html(data.t.stage);
					$("#possibility").html(data.t.possibility);
					$("#edit_by").html(data.t.edit_by);
					$("#edit_time").html(data.t.edit_time);
	...
	function changeIcon(stage, index1){
		...
		alert("当前阶段的下标" + index);
		alert("前面正常阶段和后面丢失阶段的分解点下标" + point);*/
...
<body>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		<div class="page-header">
			<h3>${t.customer_id}-${t.name} <small>￥${t.money}</small></h3>
		</div>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		-------------%>
		<span class="closingDate">${t.expected_date}</span>
	</div>
	...
	<div style="position: relative; top: 0px;">
		...
		<div style="position: relative; left: 40px; height: 30px; top: 10px;">
			...
			<div style="width: 300px;position: relative; left: 200px; top: -20px;"><b>${t.customer_id}-${t.name}</b></div>
			<div style="width: 300px;position: relative; left: 450px; top: -40px; color: gray;">预计成交日期</div>
			<div style="width: 300px;position: relative; left: 650px; top: -60px;"><b>${t.expected_date}</b></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px;"></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px; left: 450px;"></div>
		</div>
		<div style="position: relative; left: 40px; height: 30px; top: 20px;">
			<div style="width: 300px; color: gray;">客户名称</div>
			<div style="width: 300px;position: relative; left: 200px; top: -20px;"><b>${t.customer_id}</b></div>
		...
		<div style="position: relative; left: 40px; height: 30px; top: 40px;">
			...
			<div style="width: 300px;position: relative; left: 650px; top: -60px;"><b>${t.activity_id}</b></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px;"></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px; left: 450px;"></div>
		</div>
		<div style="position: relative; left: 40px; height: 30px; top: 50px;">
			<div style="width: 300px; color: gray;">联系人名称</div>
			<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b>${t.contacts_id}</b></div>
		...
		<div style="position: relative; left: 40px; height: 30px; top: 70px;">
			...
			<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b id="edit_by">${t.edit_by}&nbsp;&nbsp;</b><small id="edit_time" style="font-size: 10px; color: gray;">${t.edit_time}</small></div>
			<div style="height: 1px; width: 550px; background: #D5D5D5; position: relative; top: -20px;"></div>
		</div>
		...
		<div style="position: relative; left: 40px; height: 30px; top: 100px;">
			...
			<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b>${t.next_contact_time}</b></div>
	...
	<div style="position: relative; top: 100px; left: 40px;">
		...
		<div class="remarkDiv" style="height: 60px;">
			...
			<div style="position: relative; top: -40px; left: 40px;" >
				<h5>呵呵！</h5>
				<font color="gray">交易</font> <font color="gray">-</font> <b>动力节点-${t.name}</b> <small style="color: gray;"> 2017-01-22 10:20:10 由zhangsan</small>
				<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">
					<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #E6E6E6;"></span></a>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #E6E6E6;"></span></a>
