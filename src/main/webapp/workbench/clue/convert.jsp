...
<script type="text/javascript">
	$(function(){
		...
		// 为搜索操作模态窗孔的搜索框绑定事件，执行搜索并展现市场活动列表的操作
		...
		// 为提交（市场活动）按钮绑定事件，填充市场活动源（填写两项信息 名称+id）
		...
		$("#convertBtn").click(function(){
			...
			if($("#isCreateTransaction").prop("checked")){
				...
				// alert("需要创建交易");
				// 如果需要创建交易，我们除了要为后台传递clueId之外，还得为后台传递交易表单中的信息
				...
				// 以上传递参数的方式很麻烦，而且表单一旦扩充，挂载的参数有可能超出浏览器地址栏上的上限
...
<body>
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<!--
			提交表单行为结果：
				workbench/clue/convert.do?money=xxx&name=xxx&..&activityId=xxx
		-->
		<form id="tranForm" action="workbench/clue/convert.do" method="post">
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    ...
		    <input type="text" class="form-control time" name="expectedDate" readonly>
		  </div>
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
